...
/**
 * Created by Arnav on 18-01-2017.
 */
...
public final class QueryUtils {
    ...
    private static ArrayList<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            JSONObject x = new JSONObject(earthquakeJSON);
            JSONArray features = x.getJSONArray("features");
            ...
            for (int i = 0; i < features.length(); i++) {
                ...
                String detail = properties.getString("url");
                Earthquake earthquake1 = new Earthquake(magnitude, location, time, detail);
